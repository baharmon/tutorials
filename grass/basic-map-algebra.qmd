...
image: images/map-algebra-01.webp
...
code-links:
  - text: Jupyter notebook
    href: basic-map-algebra.ipynb
    icon: file-code
    target: _blank
resources: basic-map-algebra.ipynb
format:
  html:
    toc: true
    code-tools: true
...
![Terrain modeled with map algebra](images/map-algebra-01.webp)
...
[Get started with GRASS & Python in Jupyter Notebooks](https://grass-tutorials.osgeo.org/content/tutorials/get_started/fast_track_grass_and_python.html).
:::
...
## GUI
![r.mapcalc](images/map-algebra-02.webp)
...
![Plains](images/map-algebra-03.webp)
...
![Fractal](images/map-algebra-04.webp)
...
![Mountains](images/map-algebra-05.webp)
...
ensuring that the gradient fits the rescaled elevation range of the raster.
...
![Valleys](images/map-algebra-06.webp)
...
![Weathering](images/map-algebra-07.webp)
...
![Randomness](images/map-algebra-08.webp)
...
![Forests](images/map-algebra-09.webp)
...
![Logic in map algebra](images/map-algebra-01.svg)
...
![If statement diagram](images/map-algebra-02.svg)
...
![Zones](images/map-algebra-10.webp)
...
![If then else statement diagram](images/map-algebra-03.svg)
...
![Plateaus](images/map-algebra-11.webp)
...
![Complex expression diagram](images/map-algebra-04.svg)
...
![Rivers](images/map-algebra-12.webp)